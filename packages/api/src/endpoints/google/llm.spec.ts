...
describe('getGoogleConfig', () => {
  ...
  describe('Maps Grounding Functionality', () => {
    ...
    it('should skip maps grounding for unsupported models (gemini-1.5)', () => {
      const credentials = {
        [AuthKeys.GOOGLE_API_KEY]: 'test-api-key',
      };
    ...
    it('should skip maps grounding for gemini-1.0 models', () => {
      const credentials = {
        [AuthKeys.GOOGLE_API_KEY]: 'test-api-key',
      };
    ...
    it('should allow maps grounding for gemini-2.0-flash', () => {
      const credentials = {
        [AuthKeys.GOOGLE_API_KEY]: 'test-api-key',
      };
    ...
    it('should allow maps grounding for gemini-3.1 models', () => {
      const credentials = {
        [AuthKeys.GOOGLE_API_KEY]: 'test-api-key',
      };
